...
$(OBJDIR)/state.o: src/States/StateStack/State/State.cpp src/States/StateStack/State/State.hpp
	$(CXX) $(CXXFLAGS) $(SFMLFLAGS) -c src/States/StateStack/State/State.cpp -o $(OBJDIR)/state.o

$(OBJDIR)/state_stack.o: src/States/StateStack/StateStack.cpp src/States/StateStack/StateStack.hpp
	$(CXX) $(CXXFLAGS) $(SFMLFLAGS) -c src/States/StateStack/StateStack.cpp -o $(OBJDIR)/state_stack.o
